...
<head>
    ...
    <title>Exercise 1: Getting Started with PHP - Sonali</title>
</head>
<body>
  ...
  <h3>3.2 Create a PHP variable named $title and assign it the value "PHP is interesting."
     ...
     <h3>3.3 Define three variables: $g1 = 5, $g2 = 4, and $g3 = 5. These variables represent the grades of three students in the course. To display this information, create an HTML table within your PHP code.
         The table should be structured with columns for Serial Number (S.n.), Name, and Grade, and it should look like this:</h3>
   <?php
   $g1 = 5;
   $g2 = 4;
   $g3 = 5;
